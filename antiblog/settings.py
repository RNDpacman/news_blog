"""
Django settings for antiblog project.
...
SECRET_KEY = 'django-insecure-o1_q+2duqvm2c8*t04^yy26f9hsxj9=#1w8i8^2*pp7f46rbt!'
...
WSGI_APPLICATION = 'antiblog.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'antiblog/static'),
]
